...
model_performance_glm_lca <- extract_performance(
  cm = cm_youden,
...
saveRDS(youden_coords_train, "youden_coords_train_glm_lca.rds")
saveRDS(youden_threshold, "youden_threshold_glm_lca.rds")

saveRDS(model_performance_glm_lca, "model_performance_glm_lca.rds")
saveRDS(model_performance_glm_lca_050, "model_performance_glm_lca_050.rds")
saveRDS(model_performance_glm_lca_comparison, "model_performance_glm_lca_comparison.rds")

saveRDS(cm_youden, "confusion_matrix_glm_lca_youden.rds")
saveRDS(cm_050, "confusion_matrix_glm_lca_050.rds")

saveRDS(roc_test, "roc_glm_lca.rds")
saveRDS(auc_ci_boot, "auc_ci_boot_glm_lca.rds")

saveRDS(glm_lca_results, "glm_lca_results.rds")

# Optional: save predictions and observed outcomes ------------------------

saveRDS(pred_probs, "pred_probs_glm_lca.rds")
saveRDS(observed, "observed_glm_lca.rds")